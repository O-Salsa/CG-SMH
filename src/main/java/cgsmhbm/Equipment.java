...
public class Equipment {
	private String GLPI;
        ...
        public Equipment(String GLPI, String serialNumber, String patrimonio, String descricaoMarcaModelo, String defect, String battalion, String chamadoEmpresa, String status) {
                super();
                this.GLPI = GLPI;
	   ...
	   public String getNumeroSerie() { return numeroSerie; }
	    public void setNumeroSerie(String numeroSerie) { this.numeroSerie = numeroSerie; }
            ...
            public String getDescricaoMarcaModelo() { return descricaoMarcaModelo; }
            public void setDescricaoMarcaModelo(String descricaoMarcaModelo) { this.descricaoMarcaModelo = descricaoMarcaModelo; }
